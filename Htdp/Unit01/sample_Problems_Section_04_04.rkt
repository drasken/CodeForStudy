...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname sample_Problems_Section_04_04) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
(require 2htdp/image)
...
(define MTSCN (empty-scene WIDTH HEIGHT)) ; short for empty
;scene 
