...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex0043_0044) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
; wanted: 42
    (define (hyper x-position-of-car x-mouse y-mouse me)
      ;modified to pass the tests
      (cond
        [(string=? "button-down" me) x-mouse]
        [else x-position-of-car]))

;Exercise 44. Formulate the examples as BSL tests. Click RUN and
;watch them fail.

(check-expect (hyper 21 10 20 "enter") 21) 
(check-expect (hyper 42 10 20 "button-down") 10)
;with the cond test passed!
