...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex0039_0041_0042) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
;Solution implemented as a function
;stop the car at the right moment when calling (stop-when)
